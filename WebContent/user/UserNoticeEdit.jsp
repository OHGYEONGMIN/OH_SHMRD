...
<body>
	<div class="wrapper_admin">
		...
		<div class="adminNav">
				<div class="logo">
					<a href="user/UserTotalPower.jsp" class="logoitem"><i
						class="fas fa-home fa-3x">Enf</i></a>
				</div>
				<div class="list_group">
					<div class="menu">
						<a href="user/UserTotalPower.jsp" class="navitem"><i
							class="fas fa-charging-station fa-2x"></i>&nbsp; 전력 소비량</a>
					</div>
					<div class="menu">
						<a href="user/UserPay.jsp" class="navitem"><i
					...
					<div class="menu">
						<a href="user/UserSelectRoom.jsp" class="navitem"><i
					...
					<div>
						...
						<div>
							<textarea name="content" id=""
								style="width: 99.5%; height: 400px;" rows="8">${content }</textarea>
						</div>
			...
			<aside>
				...
				<div class="profile">
					<div class="profile_img">
						<img src="/project333333/image/woman.png" class="about_img" alt="">
					</div>
